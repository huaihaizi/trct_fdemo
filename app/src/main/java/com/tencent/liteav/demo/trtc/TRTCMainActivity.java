...
import com.tencent.liteav.demo.trtc.TestCustomVideo.PermissionUtil;
 ...
 */
public class TRTCMainActivity extends Activity implements View.OnClickListener, TRTCSettingDialog.ISettingListener, TRTCMoreDialog.IMoreListener,
        TRTCVideoViewLayout.ITRTCVideoViewLayoutListener, TRTCBeautySettingPanel.IOnBeautyParamsChangeListener {
    ...
    private ImageView ivShowMode, ivBeauty, ivCamera,iv_camera1, ivVoice, ivLog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PermissionUtil.permissionCamera(this);
        //获取前一个页面得到的进房参数
    ...
    private void initView() {
        ...
        iv_camera1 = (ImageView) findViewById(R.id.iv_camera1);
     ...
     */
    private void setTRTCCloudParam(int orientation) {
...
//        camera.startPreview();
    ...
    //获取当前横竖屏方向
    private int getLocalOrientation() {
        //获取设置的配置信息
    ...
    private void setScreenOrientation() {
        int orientation = getLocalOrientation();
        if (ActivityInfo.SCREEN_ORIENTATION_LANDSCAPE == orientation) {
    ...
    private void enterRoom() {
        // 预览前配置默认参数
        setTRTCCloudParam(getLocalOrientation());
        // 开启视频采集预览
